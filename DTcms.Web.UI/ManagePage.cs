...
namespace DTcms.Web.UI
{
    public class ManagePage : System.Web.UI.Page
    {
        ...
        #region 输出
        public void outSuccess(string whether, string Msg)
        {
            //FSHH.HQ.XYJ.Web.xyj.Vendor.CertifcateCategory.ResultView result = new FSHH.HQ.XYJ.Web.xyj.Vendor.CertifcateCategory.ResultView();
        ...
        public void outResult(object result)
        {
            ...
            Response.Clear();
            Response.Write(ecbm.Tools.JsonHelperHH.Serialize(result));
            Response.End();
        }
        #endregion
    }
