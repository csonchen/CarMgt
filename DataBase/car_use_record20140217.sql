...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'0在申�?1修改,2批准通过,3批准不通过,4出车�?5车辆使用结束' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'car_use_record', @level2type=N'COLUMN',@level2name=N'Status'
GO
