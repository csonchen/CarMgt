<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_other_cost_edit.aspx.cs" Inherits="DTcms.Web.admin.cars.cost.car_other_cost_edit" %>
...
<div id="contentTab">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>名 称：</th>
                <td><asp:TextBox ID="txtTittle" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*</label></td>
            </tr>
            <tr>
                <th>车牌：</th>
            ...
            <tr>
                <th>费用类型：</th>
                <td><asp:DropDownList id="ddlType_Code" CssClass="select2 required" runat="server">
                        <asp:ListItem Selected="True" Value="10001">保险</asp:ListItem>
                        <asp:ListItem Value="10002">年费</asp:ListItem>
                    </asp:DropDownList><label>*</label></td>
            </tr>
            </tbody>
        </table>
