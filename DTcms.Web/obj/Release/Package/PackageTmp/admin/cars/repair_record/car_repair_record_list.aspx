...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="car_repair_record_add.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加维修信息</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th align="left">维修开始时间</th>
        <th align="left">车牌</th>
        <th align="left">修理挂单人</th>
        <th align="left">维修时公里</th>
        <th align="left">下次保养公里</th>
        <th align="left">保养维修项目</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td>
            <%#new DTcms.BLL.car_repair_recordbll().GetChoiceByCode(int.Parse(Eval("ID").ToString())).Trim() == "1"?"保养":(new DTcms.BLL.car_repair_recordbll().GetChoiceByCode(int.Parse(Eval("ID").ToString())).Trim() == "2"?"维修":"保养+维修")%>
        </td>
        <td><%#new DTcms.BLL.car_repair_plantbll().GetTitleByCode((string)Eval("Repair_Plant_Code"))%></td>
        <td><%#Eval("Reason").ToString().Length <= 5 ? Eval("Reason").ToString():Eval("Reason").ToString().Substring(0,5)+"...."%></td>
