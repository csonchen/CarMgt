<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_list.aspx.cs" Inherits="DTcms.Web.admin.cars.car_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 车辆管理 &gt; 车辆列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="car_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加车辆</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th>选择</th>
        <th align="left">车辆编码</th>
        <th align="left">车辆说明</th>
        <th align="left">车型</th>
        <th align="left">驾驶员</th>
        <th align="left">购入日期</th>
        <th align="left">购入价格</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#Eval("Car_Name")%></td>
        <td><%#new DTcms.BLL.car_typebll().GetTitleByCode((string)Eval("Car_Type_Code"))%></td>
        <td><%#new DTcms.BLL.car_driverbll().GetTitleByCode((string)Eval("Driver_Code"))%></td>
        <td><%#Eval("Buy_Date")%></td>
        <td><%#Eval("Price")%></td>
        <td><%#Eval("StatusText")%></td>
        <td align="center"><a href="car_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
