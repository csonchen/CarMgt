<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_maintenance_item_edit.aspx.cs" Inherits="DTcms.Web.admin.cars.maintenance_item.car_maintenance_item_edit" %>
...
<div id="contentTab">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                <th>名 称：</th>
                <td><asp:TextBox ID="txtMaintenance_Item_Name" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*</label></td>
            </tr>
            </tbody>
        </table>
    </div>
