<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="driver_subsidy_report.aspx.cs" Inherits="DTcms.Web.admin.report.driver_subsidy_report" %>
...
<script type="text/javascript">
    ...
    function export_click() {
        ...
        $.ajax({
            url: "driver_subsidy_report.aspx?task=exportReport",
            data: {
                "stime": strstime,
                "etime": stretime,
    ...
    function exportForMonth_click() {
        ...
        $.ajax({
            url: "driver_subsidy_report.aspx?task=exportReportForMonDri",
            data: {
                "year": year,
                "month": month,
                "dricode": dricode
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 报表管理 &gt; 司机行车补助表</div>
    <!--begin按月份,驾驶员导出报表-->
    <div class="tools_box">
	    <div class="tools_bar">
