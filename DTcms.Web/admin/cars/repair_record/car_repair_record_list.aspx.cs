...
{
    public partial class car_repair_record_list : Web.UI.ManagePage
    {
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and (Repare_Time like '%" + _keywords + "%' or Code like '%" + _keywords + "%')");
            }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("car_repair_record_list_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("car_repair_record_list.aspx", "group_id={0}&keywords={1}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("car_repair_record_list_page_size", _pagesize.ToString(), 43200);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("car_repair_record_list.aspx", "group_id={0}&keywords={1}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("car_repair_record_list.aspx", "group_id={0}&keywords={1}",
