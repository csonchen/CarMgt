    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList id="ddlUser_Code" CssClass="select2 required" runat="server" Enabled="false"></asp:DropDownList>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList id="ddlCar_Number" CssClass="select2 required" runat="server" 
                         onselectedindexchanged="ddlCar_Number_SelectedIndexChanged"  AutoPostBack="True">
                    </asp:DropDownList>
                ...
                <td>
                    <asp:DropDownList id="ddlDriver_Code" CssClass="select2 required" runat="server"
                        onselectedindexchanged="ddlDriver_Code_SelectedIndexChanged"  AutoPostBack="True">
                    </asp:DropDownList>
