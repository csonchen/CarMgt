<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_deptlist.aspx.cs" Inherits="DTcms.Web.admin.users.dept.user_deptlist" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 部门管理 &gt; 部门列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="user_dept_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加部门</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td align="center"><a href="user_dept_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
