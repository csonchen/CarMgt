...
{
    public partial class norules_class_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("norules_class_list.aspx", "group_id={0}&keywords={1}&page={2}",
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("norules_class_list_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("norules_class_list.aspx", "group_id={0}&keywords={1}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("norules_class_list_page_size", _pagesize.ToString(), 43200);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("norules_class_list.aspx", "group_id={0}&keywords={1}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("norules_class_list.aspx", "group_id={0}&keywords={1}",
