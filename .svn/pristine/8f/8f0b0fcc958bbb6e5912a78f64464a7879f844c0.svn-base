<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_repair_report.aspx.cs" Inherits="DTcms.Web.admin.report.car_repair_report" %>
...
<script type="text/javascript">
    ...
    function export_click() {
        ...
        $.ajax({
            url: "car_repair_report.aspx?task=exportReportForMonth",
            data: {
                "stime": strstime,
                "etime": stretime,
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 报表管理 &gt; 车辆维修费汇总列表</div>
     <div class="tools_box">
	    <div class="tools_bar">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th>选择</th>
        <th align="left">车辆维修费汇总编码</th>
        <th align="left">车辆维修费汇总名称</th>
        <th>操作</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
