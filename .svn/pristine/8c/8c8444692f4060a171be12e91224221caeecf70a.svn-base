<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_type_list.aspx.cs" Inherits="DTcms.Web.admin.cars.type.car_type_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 车型管理 &gt; 车型列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="car_type_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加车型</b></span></a>
