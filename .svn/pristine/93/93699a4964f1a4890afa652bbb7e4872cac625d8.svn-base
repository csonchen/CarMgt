...
namespace DTcms.Web.admin.report
{
    public partial class oil_cost_report : Web.UI.ManagePage
    {
        ...
        public void exportReportForMonth() {
            ...
            DataToExcel.DataTableToExcelForStyle(dt, list, "oil_cost2.xls", "车辆燃油费用累总",
                 false, false,false,false, 1, 1, 1, 6);

            outSuccess("Y", "oil_cost2.xls");
            #endregion
        }
        ...
        public void exportReport()
        {
            ...
            DataTable tbcarcosted = bll.GetCarUseCost(0, where, "Return_Time").Tables[0];
