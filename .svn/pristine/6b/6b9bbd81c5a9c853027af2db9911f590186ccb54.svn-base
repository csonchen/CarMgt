...
<script type="text/javascript">
    ...
    function export_click() {
        ...
        $.ajax({
            url: "car_repair_report.aspx?task=exportReport",
            data: {
                "stime": strstime,
                "etime": stretime,
...
<form id="form1" runat="server">
    ...
    <div class="tools_box">
	    <div class="tools_bar">
           ...
           <%-- <a href="car_type_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加车辆维修费汇总</b></span></a>
