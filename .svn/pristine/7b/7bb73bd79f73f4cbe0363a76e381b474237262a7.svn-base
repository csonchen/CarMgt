...
{
    public partial class user_deptlist : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Utils.CombUrlTxt("user_deptlist.aspx", "group_id={0}&keywords={1}&page={2}",
        ...
        protected string CombSqlTxt(string _keywords)
        {
            ...
            {
                strTemp.Append(" and (Dept_Name like '%" + _keywords + "%' or Dept_Code like '%" + _keywords + "%')");
            }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("user_deptlist_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("user_deptlist.aspx", "group_id={0}&keywords={1}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("user_deptlist_page_size", _pagesize.ToString(), 43200);
                }
            }
            Response.Redirect(Utils.CombUrlTxt("user_deptlist.aspx", "group_id={0}&keywords={1}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("批量删除成功啦！", Utils.CombUrlTxt("user_deptlist.aspx", "group_id={0}&keywords={1}",
