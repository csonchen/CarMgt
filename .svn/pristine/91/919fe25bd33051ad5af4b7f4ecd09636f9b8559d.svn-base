...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 值班项管理 &gt; 值班项列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="work_items_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加值班项</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th>选择</th>
        <th align="left">值班项编码</th>
        <th align="left">值班项名称</th>
        <th align="left">费用</th>
        <th>操作</th>
      </tr>
    </HeaderTemplate>
