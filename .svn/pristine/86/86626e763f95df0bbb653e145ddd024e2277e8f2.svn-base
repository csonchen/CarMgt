...
<%--            <%if (IsAdminLevel("sys_plugin", DTEnums.ActionEnum.View.ToString()))
            ...
            <div title="车辆维修管理" iconcss="menu-icon-model" class="l-scroll">
                <ul id="car_repair_tree" class="nlist">
                    ...
                    <li><a href="javascript:f_addTab('car_repair_record_edit','维修完成','cars/repair_record/car_repair_record_edit.aspx')" onclick="change_libg(this,'car_repair_tree')">维修完成</a></li>
            ...
            <div title="基础信息管理" iconcss="menu-icon-model" class="l-scroll">
                <ul id="car_base_tree" class="nlist">
                    ...
                    <li><a href="javascript:f_addTab('work_items_list','值班项管理','work/item/work_items_list.aspx')" onclick="change_libg(this,'car_base_tree')">值班项管理</a></li>
                </ul>
            </div>
