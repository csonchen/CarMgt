<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_role_list.aspx.cs" Inherits="DTcms.Web.admin.users.role.user_role_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 角色管理 &gt; 角色列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="user_role_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加角色</b></span></a>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#Eval("Role_Code")%></td>
        <td><%#Eval("Role_Name")%></td>
        <td align="center"><a href="user_role_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
