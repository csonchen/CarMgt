<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="driver_work_report.aspx.cs" Inherits="DTcms.Web.admin.report.driver_work_report" %>
...
<script type="text/javascript">
    ...
    function export_click() {
        ...
        $.ajax({
            url: "driver_work_report.aspx?task=exportReport",
            data: {
                "stime": strstime,
                "etime": stretime,
    ...
    function exportForMonth_click() {
        ...
        //获取选中的部门属性
        var proSelIndex = document.getElementById("DropDownList1").selectedIndex;
        var pro = document.getElementById("DropDownList1")[proSelIndex].value;
        $.ajax({
            url: "driver_work_report.aspx?task=exportReportForMonth",
            data: {
                "year": year,
                "month": month,
                "pro": pro
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 报表管理 &gt; 行政司机出车汇总列表</div>
    <!--begin按月份导出报表-->
    <div class="tools_box">
	    <div class="tools_bar">
            <div style="margin-left:10px;margin-top:10px;float:left">
                ...
                月
                <asp:DropDownList id="DropDownList1" CssClass="select2 required" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th>选择</th>
        <th align="left">行政司机出车汇总编码</th>
        <th align="left">行政司机出车汇总名称</th>
        <th>操作</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
