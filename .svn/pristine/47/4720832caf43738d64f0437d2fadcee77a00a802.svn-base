<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work_items_list.aspx.cs" Inherits="DTcms.Web.admin.work.item.work_items_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 补助项管理 &gt; 补助项列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="work_items_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加补助项</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th>选择</th>
        <th align="left">补助项编码</th>
        <th align="left">补助项名称</th>
        <th align="left">费用</th>
        <th>操作</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
      <tr>
        ...
        <td><%#Eval("Item_Cost")%></td>
        <td align="center"><a href="work_items_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&id=<%#Eval("ID")%>">修改</a></td>
      </tr>
    </ItemTemplate>
    <FooterTemplate>
