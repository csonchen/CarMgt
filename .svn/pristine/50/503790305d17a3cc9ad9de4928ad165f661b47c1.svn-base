<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="employee_list.aspx.cs" Inherits="DTcms.Web.admin.users.employee_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 控制面板 &gt; 员工管理</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="employee_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加员工</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">选择</th>
        <th width="10%" align="left">部门</th>
        <th width="10%" align="left">职位</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#new DTcms.BLL.user_rolebll().GetTitleByCode((string)Eval("Role_Code"))%></td>
