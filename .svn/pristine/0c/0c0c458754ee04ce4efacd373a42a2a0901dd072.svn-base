<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="car_use_report.aspx.cs" Inherits="DTcms.Web.admin.report.car_use_report" %>
...
<script type="text/javascript">
    ...
    function export_click() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: "car_use_report.aspx?task=exportReport",
            data: {
                "stime": strstime,
                "etime": stretime,
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 报表管理 &gt; 派车单汇总列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
